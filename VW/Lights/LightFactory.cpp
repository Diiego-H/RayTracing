...
shared_ptr<Light> LightFactory::createLight(vec3 posicio, vec3 Ia, vec3 Id, vec3 Is, float a, float b, float c, LIGHT_TYPES t) {
    ...
    case POINTLIGHT:
        ...
        break;
    case AREALIGHT:
        // Posem el radi a 1 ja que no es passa per parametre
        l = make_shared<AreaLight>(posicio, Ia, Id, Is, a, b, c, 1.0f);
        break;
    default:
        break;
    }
...
LightFactory::LIGHT_TYPES LightFactory::getIndexType (shared_ptr<Light> l) {
    ...
    else if (dynamic_pointer_cast<AreaLight>(l) != nullptr) {
        return LIGHT_TYPES::AREALIGHT;
    }
    return LIGHT_TYPES::POINTLIGHT;
}
